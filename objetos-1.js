/**
 * En un formulario de registro, me gustaría almacenar la información de reservar un escape room en escaperrombarcelona.com
 *
 * - dia
 * - hora
 * - nombre del escape
...
console.log(registro.caracteristicas.includes("Fantasia"));

// ¿Cómo se llama el escape que hemos reservado?
console.log(registro.nomEscape);
